...
import { CustomerComponent } from './components/customerordercomponent/app.customer.component';
import { OrderComponent } from './components/customerordercomponent/app.order.component';
import { SearchBarComponent } from './components/customerordercomponent/app.searchbar.component';
...
@NgModule({
  ...
  providers: [],
  bootstrap: [ SearchBarComponent, CustomerComponent, OrderComponent]
})
